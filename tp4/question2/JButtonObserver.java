...
public class JButtonObserver implements ActionListener{ // à compléter
     ...
     *            compléter
     */
    public void actionPerformed/* à compléter */(ActionEvent ae) {
        String message = String.format("observateur %s : clic du bouton %s",this.nom != null ?this.nom:"",ae.getActionCommand()); // à compléter, inspirez-vous de l'applette de l'énoncé
